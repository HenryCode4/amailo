...
export default function CartProvider({children}) {
    ...
    useEffect(()=> {
        ...
        localStorage.setItem(CART_KEY, JSON.stringify(cartData)); // stringify cartData before storing
    ...
    function getCartFromLocalStorage(){
        ...
        try {
            ...
            // If there's an error parsing, return EMPTY_CART or handle it accordingly
            return EMPTY_CART;
        }
    }
